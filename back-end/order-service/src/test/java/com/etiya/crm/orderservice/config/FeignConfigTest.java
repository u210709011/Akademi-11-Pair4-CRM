...
class FeignConfigTest {
	...
	@Test
	void jwtInterceptor_throws_whenNoUserAuthentication() {
		SecurityContextHolder.clearContext();
		RequestTemplate template = new RequestTemplate();
		FeignConfig.JwtTokenPropagationInterceptor interceptor = new FeignConfig.JwtTokenPropagationInterceptor();
