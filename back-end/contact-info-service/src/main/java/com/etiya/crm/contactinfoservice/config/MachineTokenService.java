 ...
 * (thread-local) bos gelir. Bu servis, o durumlarda lookup-service/customer-service'e
 * erismek icin "contact-info-service-m2m" client'inin (serviceAccountsEnabled=true,
 * bkz. infra/keycloak/crm-realm.json) client_credentials grant'iyla kendi
