...
@Tag(name = SwaggerText.PRODUCT_TAG_NAME, description = SwaggerText.PRODUCT_TAG_DESCRIPTION)
@RestController
...
public class ProductController {
    ...
    @Operation(summary = SwaggerText.PRODUCT_CREATE_SUMMARY)
    @PostMapping
    ...
    @Operation(summary = SwaggerText.PRODUCT_UPDATE_SUMMARY)
    ...
    @Operation(summary = SwaggerText.PRODUCT_GET_BY_ID_SUMMARY)
    ...
    @Operation(summary = SwaggerText.PRODUCT_GET_ALL_SUMMARY)
    @GetMapping
    ...
    @Operation(summary = SwaggerText.PRODUCT_DELETE_SUMMARY)
