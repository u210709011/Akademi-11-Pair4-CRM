 ...
 * anlamini asla degistirme" kurali; ayni prensip TYPE_VALUE_ID'nin ait oldugu grup icin de gecerli). */
@Schema(description = "PUT /api/v1/type-values/{id} istek govdesi.")
