...
@Schema(description = "POST /api/v1/general-statuses istek govdesi.")
public record CreateGnlStRequest(
        ...
        @Schema(description = "Grup kodu - TYPE_VALUE'nun join anahtari, benzersiz olmali.", example = "CUST_STATUS")
