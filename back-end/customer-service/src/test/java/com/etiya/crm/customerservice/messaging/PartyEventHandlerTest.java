...
class PartyEventHandlerTest {
	...
	@InjectMocks
	private PartyEventHandler handler;
	...
	@Test
	void handle_skipsSync_whenCustomerNotFound() {
		PartyEvent event = individualCreatedEvent();
	...
	@Test
	void handle_upsertsNewSearchView_withRoleResolved() {
		PartyEvent event = individualCreatedEvent();
	...
	@Test
	void handle_updatesExistingSearchView_inPlace() {
		PartyEvent event = individualCreatedEvent();
		Customer customer = activeCustomer(42L, event.partyRoleId());
	...
	@Test
	void handle_marksSearchViewDeleted_whenCustomerInactive() {
		PartyEvent event = individualCreatedEvent();
	...
	@Test
	void handle_leavesRoleNull_whenPartyRoleTypeIdMissing() {
