...
class FeignConfigTest {
	...
	@Test
	void acceptLanguageInterceptor_addsNoHeader_whenRequestHasNoAcceptLanguage() {
	...
	@Test
	void acceptLanguageInterceptor_addsNoHeader_whenNoRequestContext_egKafkaListenerThread() {
		RequestContextHolder.resetRequestAttributes();
		RequestTemplate template = new RequestTemplate();
