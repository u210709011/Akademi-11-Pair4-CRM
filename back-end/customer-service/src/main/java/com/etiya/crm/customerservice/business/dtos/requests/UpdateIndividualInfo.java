 ...
 */
@Schema(description = SwaggerText.UPDATE_INDIVIDUAL_INFO_SCHEMA_DESCRIPTION)
public record UpdateIndividualInfo(
		...
		@Schema(description = SwaggerText.INDIVIDUAL_INFO_LAST_NAME_DESCRIPTION, example = "Yilmazoglu")
		@NotBlank(message = "{" + MessageKeys.FIELD_REQUIRED + "}")
		@Size(max = 50, message = "{" + MessageKeys.FIELD_MAX_LENGTH + "}")
		@Pattern(regexp = "^[a-zA-ZçÇğĞıİöÖşŞüÜ\\s]*$", message = "{" + MessageKeys.NAME_INVALID + "}")
		String lastName,
		...
		@Schema(description = SwaggerText.UPDATE_INDIVIDUAL_INFO_NATIONAL_ID_DESCRIPTION,
